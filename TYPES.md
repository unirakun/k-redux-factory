...
| `replace` | replace an existing instance of your resource, like update but delete props not valued | `replace(<instance>)` | `{ type: '@trampss/REPLACE_TODOS', payload: <instance> }` |
